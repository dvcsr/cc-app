  ...
  return (
    <div>
      <div className="absolute inset-0 -z-[99] opacity-90 h-[24rem] bg-auto">
        ...
        <div className="container mx-auto relative z-0 p-4 text-end">
        ...
        <Link href="/product" className="bg-white bg-opacity-10 text-yellow-100 hover:text-yellow-400 text-xs md:text-lg xl:text-2xl rounded-full hover:font-extrabold py-2 px-4 textshadow">
            LEARN MORE
          </Link>
        </div>
      </section>
