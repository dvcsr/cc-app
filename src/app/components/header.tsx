...
const Header:FC = () => {return(
  ...
  <Link href="/team" className="w-[100px] sm:w-[100px] hover:w-[120px] hover:bg-amber-200 transition-all duration-20 rounded-full border border-gray-300 px-2 py-1 focus:outline-none hover:text-amber-600 text-center">Team</Link>
  <Link href="/about" className="w-[100px] sm:w-[100px] hover:w-[120px] hover:bg-amber-200 transition-all duration-20 rounded-full border border-gray-300 px-2 py-1 focus:outline-none hover:text-amber-600 text-center">About</Link>
    </div>
    </div>
    <div className="text-white h-4/6 flex-col xl:flex-row">
      {/* text in hero */}
      <div className="h-1/2 xl:h-px pl-3 pt-4 xl:pt-28">
        <h2 className="font-black tracking-widest italic w-1/3 md:text-xl xl:text-4xl xl:leading-relaxed">"REVOLUTIONARY lightbulb like NEVER BEFORE"</h2>
        <p className="w-1/3 pt-4 md:text-lg xl:text-xl">ultra-efficient, abuse-resistant B2B lighting solution for your business</p>
      </div>
      <div className="flex h-1/2 xl:h-px pr-4 text-right xl:pt-14">
      <div className="content w-2/3">
      </div>
        <div className="w-1/3 -mt-12 xl:-mt-3">
        <h2 className="font-black tracking-widest italic md:text-xl xl:text-4xl xl:leading-relaxed">"TRUSTED by LEADERS in Southeast Asia"</h2>
